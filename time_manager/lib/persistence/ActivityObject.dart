class ActivityObject {
  ...
  Map<String, String> toMap() =>
      {'starttime': starttime.millisecondsSinceEpoch.toString(), 'endtime': endtime.microsecondsSinceEpoch.toString(), 'category': category, 'name': name, 'description': description, 'id': id.toString()};
